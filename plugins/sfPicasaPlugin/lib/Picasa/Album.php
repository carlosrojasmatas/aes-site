...
class Picasa_Album {
	...
	public function __construct ($url=null,SimpleXMLElement $albums=null, $contextArray=null, $useCache=true) {
		...
		if ($albums != null) {
			...
			$this->id = $albums->id;
			$this->title = (string) $albums->title;
			$this->updated = (string) $albums->updated;
			$this->published = (string) $albums->published;
			$this->summary = (string) $albums->summary;
			$this->rights = (string) $albums->rights;
			$this->author = $albums->author->name;
			$this->subtitle = (string) $albums->subtitle;
			$this->comments = null;
