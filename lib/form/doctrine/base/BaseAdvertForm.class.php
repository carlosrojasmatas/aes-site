...
abstract class BaseAdvertForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'f_image_path' => new sfWidgetFormTextarea(),
      'f_image_name' => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'f_image_path' => new sfValidatorString(),
      'f_image_name' => new sfValidatorString(),
      'image_path'   => new sfValidatorString(),
