...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('resource', 'resource_parent_id_album_id', array(
             'name' => 'resource_parent_id_album_id',
             'local' => 'parent_id',
             'foreign' => 'id',
             'foreignTable' => 'album',
             ));
    ...
    {
        $this->dropForeignKey('resource', 'resource_parent_id_album_id');
